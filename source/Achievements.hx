...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Exeller",						"Well Well, You killed them all ?",								'death_timeline',		 true],
		["Boyfriend.Xml",				"You made survive the funker only, what a pity",				'silent_hill',			false],
		["Knuckles And Eggman",			"Knuckles and Eggman ? You want to recreate Sonic 3 ?",			'fly_away',				false],
		["Tails And Boyfriend.Xml",		"The fox and the humain survived, not for long…",				'cry_hill',				false],
		["Tails And Knuckles",			"Dont worry it’s not over yet eheheh…",							'freedom_center',		false],
		["Boyfriend.Xml And Eggman",	"2 humains ??? That will be even more easy than the others",	'sky_base',				false],
		["Knuckles And Boyfriend.Xml",	"The echidna and the funker, I feel something is off",			'hydrocity',			false],
		["Exeller And Majin",			"Ahah i was sure that I was gonna beat this dumbass",			'majin_forest',			 true],
		["Good Ending",					"… I will get you next time, and I will be even more powerful…", 'sky_sanctuary',		false]	
	];
